...
// MSG_CONFIRM does not exist on macOS, setting it as zero bypasses the error
#if defined(__APPLE__)
#define MSG_CONFIRM 0
#endif

// MSG_CONFIRM and MSG_WAITALL do not exist on Windows, setting them as zero bypasses the error
#if defined(_WIN32)
#define MSG_CONFIRM 0
...
protected:
    ...
    int establishConnectionMatlabUDP()
    {
        ...
        // std::cout << "@Tudat: Ended ping " << status << " " << EMSGSIZE <<  " \n";
